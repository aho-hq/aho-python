...
class OpenBadgeSchemaExample(TypedDict, total=False):
    """Example: Creating an Open Badges 3.0 schema. Note: SD-JWT VC format is NOT supported for OB 3.0."""
    pass

class OpenBadgeCredentialExample(TypedDict, total=False):
    """Example: Issuing an Open Badges 3.0 credential"""
    pass
...
class DataIntegrityConfig(TypedDict, total=False):
...
class IssuerCredentialSchema(TypedDict, total=False):
    ...
    schema_type: Literal["custom", "education_credential", "employment_credential", "certificate", "open_badge", "clr"]
    ...
    data_integrity_config: NotRequired[DataIntegrityConfig]
