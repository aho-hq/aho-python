...
- Only ecdsa-sd-2023 supports selective disclosure"""
    ...
    default_cryptosuite: Optional[Any] = None
    mandatory_pointers: Optional[list[str]] = None
    selectable_claims: Optional[list[str]] = None
...
class IssuerCredentialSchema(BaseModel):
    ...
    data_integrity_config: Optional[DataIntegrityConfig] = None
